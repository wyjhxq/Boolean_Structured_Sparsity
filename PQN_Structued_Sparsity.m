...
%% add paths
addpath(genpath("./PQN"));% put PQN downloaded from: https://www.cs.ubc.ca/~schmidtm/Software/PQN.html in the current folder
addpath(genpath(".../gurobi910/linux64/matlab/")); % add path to the gruobi folder
